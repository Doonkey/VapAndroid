...
class AnimPlayer(val animView: IAnimView) {
    ...
    var windowSeekTo: Pair<Int, Long> = Pair(0, 0)
        set(value) {
    ...
    val playlist = ArrayList<IFileContainer>()
    var playlistIndex = 0
    ...
    fun addMediaItem(fileContainer: IFileContainer) {
        playlist.add(fileContainer)
    }
