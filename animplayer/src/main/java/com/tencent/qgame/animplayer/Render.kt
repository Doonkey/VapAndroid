...
class Render(surfaceTexture: SurfaceTexture): IRenderListener {
    ...
    private var textureMatrix = FloatArray(16).apply {
    ...
    override fun initRender() {
        ...
        uTextureMatrixLocation = GLES20.glGetUniformLocation(shaderProgram, "uTextureMatrix")
    ...
    override fun setUpdateMatrix(matrix: FloatArray) {
