...
class AudioPlayer(val player: AnimPlayer) {
    ...
    fun seekTo(windowSeekTo: Pair<Int, Long>) {
    ...
    private fun startPlay(fileContainer: IFileContainer) {
        ...
        val audioTrack =
            AudioTrack(AudioManager.STREAM_MUSIC, sampleRate, channelConfig, AudioFormat.ENCODING_PCM_16BIT, bufferSize, AudioTrack.MODE_STREAM)
